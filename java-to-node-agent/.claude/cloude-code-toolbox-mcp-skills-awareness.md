...
_Generated: 2026-04-04T03:26:30.596Z_
...
Workspace `mcp.json` _(folder: java-to-node-agent)_

- **c:\Users\ha9196k\Documents\spring-rest-sakila\java-to-node-agent\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\ha9196k\AppData\Roaming\Code\User\mcp.json** — _File missing_
