...
class LLMClient:
    ...
    def __init__(self, settings: Optional[Settings] = None) -> None:
        ...
        # Set to True by _truncate_prompt when it fires; reset at the start of each
        # generate() call.  NOTE: not thread-safe — each LLMCodeGenerator owns its own
        # LLMClient instance, so concurrent access is not an issue in practice.
        self._last_call_was_truncated: bool = False
    ...
    def generate(
        ...
        self._last_call_was_truncated = False
    ...
    def _truncate_prompt(
        ...
        try:
            ...
            self._last_call_was_truncated = True
            logger.warning(
